...
export interface restaurantsPageQuery_AllCategoriesOutput_categories {
  __typename: "Category";
  id: number;
  name: string;
...
export interface restaurantsPageQuery_AllCategoriesOutput {
  __typename: "AllCategoriesOutput";
  ok: boolean;
  error: string | null;
  categories: restaurantsPageQuery_AllCategoriesOutput_categories[] | null;
}
...
export interface restaurantsPageQuery {
  AllCategoriesOutput: restaurantsPageQuery_AllCategoriesOutput;
